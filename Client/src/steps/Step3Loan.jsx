      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl p-6 shadow">
            ...
            <h3 className="text-3xl font-bold mt-1">₹ {emi}</h3>
          ...
          <div>
            ...
            <p className="text-blue-700 font-semibold mt-2">{tenure} Months</p>
          </div>
        ...
        <div className="bg-white  rounded-xl p-6 shadow-xl">
          <h3 className="text-center font-semibold mb-4">Payment Breakdown</h3>
