...
import { CheckCircle2, ArrowRight, ShieldCheck, Users, Zap } from 'lucide-react';
...
export default function HeroSection() {
  ...
  return (
    // Changed min-h and removed top padding to ensure it starts exactly at the top
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center w-full py-12 lg:py-0">
        ...
        >
          <div className="space-y-6">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black leading-[1] tracking-tight text-white">
            ...
            <p className="text-slate-400 text-lg md:text-xl max-w-lg mx-auto lg:mx-0 leading-relaxed">
              Unlock financial freedom up to <span className="text-white font-bold text-2xl">₹40 Lacs</span>. 
              Simple process, transparent rates, and <span className="text-emerald-400">zero stress.</span>
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-5 pt-4">
            <button className="w-full sm:w-auto group relative px-10 py-5 bg-blue-600 rounded-2xl font-black text-lg transition-all hover:bg-blue-500 hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] active:scale-95 flex items-center justify-center gap-3">
              APPLY FOR LOAN 
              <ArrowRight size={22} className="group-hover:translate-x-2 transition-transform" />
            </button>
            
            <button className="w-full sm:w-auto px-10 py-5 bg-transparent border-2 border-white/10 rounded-2xl font-bold text-lg hover:bg-white hover:text-black transition-all">
              View Schemes
            </button>
          </div>
          ...
          <div className="pt-8 flex items-center justify-center lg:justify-start gap-8 border-t border-white/5">
            <div className="text-center lg:text-left">
              ...
              <p className="text-slate-500 text-xs uppercase tracking-widest font-bold">Disbursed</p>
            </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <div>
                <p className="text-white font-bold text-sm leading-none text-left">Verified</p>
